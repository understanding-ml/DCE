# The code originates from https://github.com/danwley/GLOBE-CE/blob/main/datasets.py
# Paper for reference:
...
class dataset_loader:
    def __init__(
        self, name=None, data_path="datasets/", dropped_features=[], n_bins=None
    ):
        """
    ...
    def get_split(
        ...
        # Ensure numeric dtype for downstream stats/torch conversion
        ...
        # Avoid divide-by-zero when a column has zero variance
        x_stds[x_stds == 0] = 1.0
